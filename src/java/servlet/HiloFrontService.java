...
public class HiloFrontService{
    DataOutputStream salidaCaching;
    DataOutputStream salidaIndex;
    ...
    public HiloFrontService(String query, ArrayList Stopwords, String ipCaching, String ipIndex, String puerto) {
        this.query = query;
